 ...
 */
export enum BenefitDescriptionType {
    ADMINISTRATIV_FORPLEINING = 'AdministrativForpleining',
    AKSJER_GRUNNFONDSBEVIS_TIL_UNDERKURS = 'AksjerGrunnfondsbevisTilUnderkurs',
    ANNET = 'Annet',
    ARBEIDSINNTEKT_UNDER_GRENSEN_FOR_OPPLYSNINGSPLIKT = 'ArbeidsinntektUnderGrensenForOpplysningsplikt',
    ARBEIDSOPPHOLD_KOST = 'ArbeidsoppholdKost',
    ARBEIDSOPPHOLD_LOSJI = 'ArbeidsoppholdLosji',
    BARNEPENSJON = 'Barnepensjon',
    BARNEPENSJON_FRA_ANDRE_ENN_FOLKETRYGDEN_FRA2024 = 'BarnepensjonFraAndreEnnFolketrygdenFra2024',
    BEDRIFTSBARNEHAGEPLASS = 'Bedriftsbarnehageplass',
    BEREGNET_SKATT = 'BeregnetSkatt',
    BESOEKSREISER_HJEMMET_ANNET = 'BesoeksreiserHjemmetAnnet',
    BESOEKSREISER_HJEMMET_KILOMETERGODTGJOERELSE_BIL = 'BesoeksreiserHjemmetKilometergodtgjoerelseBil',
    BESOEKSREISER_HJEMMET_KOST = 'BesoeksreiserHjemmetKost',
    BETALT_TRYGDEAVGIFT = 'BetaltTrygdeavgift',
    BIL = 'Bil',
    BOLIG = 'Bolig',
    BONUS = 'Bonus',
    BONUS_FRA_FORSVARET = 'BonusFraForsvaret',
    BRAKKELEIE = 'Brakkeleie',
    ELEKTRONISK_KOMMUNIKASJON = 'ElektroniskKommunikasjon',
    ETTERLOENN = 'Etterloenn',
    ETTERLOENN_OG_ETTERPENSJON = 'EtterloennOgEtterpensjon',
    FAGFORENINGSKONTINGENT = 'Fagforeningskontingent',
    FAST_BILGODTGJOERELSE = 'FastBilgodtgjoerelse',
    FASTLOENN = 'Fastloenn',
    FAST_TILLEGG = 'FastTillegg',
    FERIEPENGER = 'Feriepenger',
    FLYTTEGODTGJOERELSE = 'Flyttegodtgjoerelse',
    FOEDERAAD = 'Foederaad',
    FOND_FOR_IDRETTSUTOEVERE = 'FondForIdrettsutoevere',
    FORSKUDDSTREKK = 'Forskuddstrekk',
    KORRIGERING_AV_FORSKUDDSTREKK = 'KorrigeringAvForskuddstrekk',
    FRI_TRANSPORT = 'FriTransport',
    GODTGJOERELSE_IHHT_SAERAVTALER_UTLAND = 'GodtgjoerelseIHhtSaeravtalerUtland',
    GODTGJOERELSE_SAERAVTALE_UTLAND = 'GodtgjoerelseSaeravtaleUtland',
    HELLIGDAGSTILLEGG = 'Helligdagstillegg',
    HONORAR_AKKORD_PROSENT_PROVISJON = 'HonorarAkkordProsentProvisjon',
    HYRETILLEGG = 'Hyretillegg',
    IKKE_SKATTEPLIKTIG_LOENN_FRA_UTENLANDSK_DIPLOM_KONSUL_STASJON = 'IkkeSkattepliktigLoennFraUtenlandskDiplomKonsulStasjon',
    INNBETALING_TIL_UTENLANDSK_PENSJONSORDNING = 'InnbetalingTilUtenlandskPensjonsordning',
    IPA_ELLER_IPS_BARNEPENSJON_FRA2024 = 'IpaEllerIpsBarnepensjonFra2024',
    KAPITAL_INNTEKT = 'KapitalInntekt',
    KILDESKATT_PAA_PENSJON = 'KildeskattPaaPensjon',
    KILOMETERGODTGJOERELSE_ANDRE_FREMKOMSTMIDLER = 'KilometergodtgjoerelseAndreFremkomstmidler',
    KILOMETERGODTGJOERELSE_BIL = 'KilometergodtgjoerelseBil',
    KILOMETERGODTGJOERELSE_EL_BIL = 'KilometergodtgjoerelseElBil',
    KILOMETERGODTGJOERELSE_PASSASJERTILLEGG = 'KilometergodtgjoerelsePassasjertillegg',
    KOMMUNAL_OMSORGSLOENN_OG_FOSTERHJEMSGODTGJOERELSE = 'KommunalOmsorgsloennOgFosterhjemsgodtgjoerelse',
    KOMPENSASJONSTILLEGG_BOLIG = 'KompensasjonstilleggBolig',
    KORRIGERING_AV_EKSTRA_ARBEIDSGIVERAVGIFT = 'KorrigeringAvEkstraArbeidsgiveravgift',
    KORRIGERING_AV_ARBEIDSGIVERAVGIFT = 'KorrigeringAvArbeidsgiveravgift',
    KORRIGERING_AV_FERIEPENGEAVSETNING = 'KorrigeringAvFeriepengeavsetning',
    KOSTBESPARELSE_IHJEMMET = 'KostbesparelseIHjemmet',
    KOST_DAGER = 'KostDager',
    KOST_DOEGN = 'KostDoegn',
    LOENN_ETTER_DOEDSFALL = 'LoennEtterDoedsfall',
    LOENN_FOR_BARNEPASS_IBARNETS_HJEM = 'LoennForBarnepassIBarnetsHjem',
    LOENNSFORSKUDD = 'Loennsforskudd',
    LOENN_TIL_PRIVATPERSONER_FOR_ARBEID_IHJEMMET = 'LoennTilPrivatpersonerForArbeidIHjemmet',
    LOENN_UTBETALT_AV_VELDEDIG_ELLER_ALLMENNYTTIG_INSTITUSJON_ELLER_ORGANISASJON = 'LoennUtbetaltAvVeldedigEllerAllmennyttigInstitusjonEllerOrganisasjon',
    LOENN_UTENLANDSK_ARTIST = 'LoennUtenlandskArtist',
    LOSJI = 'Losji',
    LOSJI_EGEN_BRAKKE_CAMPINGVOGN = 'LosjiEgenBrakkeCampingvogn',
    LOSJI_EGEN_BRAKKE_ELLER_CAMPINGVOGN = 'LosjiEgenBrakkeEllerCampingvogn',
    LOTT_KUN_TRYGDEAVGIFT = 'LottKunTrygdeavgift',
    OPPGROSSINGSTABELLNUMMER = 'Oppgrossingstabellnummer',
    OPSJONER = 'Opsjoner',
    OVERTIDSGODTGJOERELSE = 'Overtidsgodtgjoerelse',
    OVERTIDSMAT = 'Overtidsmat',
    PENSJON_OG_LIVRENTER_IARBEIDSFORHOLD = 'PensjonOgLivrenterIArbeidsforhold',
    PREMIE_TIL_FOND_OG_TRYGD = 'PremieTilFondOgTrygd',
    PREMIE_TIL_PENSJONSORDNINGER = 'PremieTilPensjonsordninger',
    REFUSJON_NEGATIVE_ETTEROPPGJOER = 'RefusjonNegativeEtteroppgjoer',
    REFUSJON_NEGATIVE_ETTEROPPGJOER_KILDESKATT = 'RefusjonNegativeEtteroppgjoerKildeskatt',
    REFUSJON_SYKEPENGER = 'RefusjonSykepenger',
    REFUSJON_UTLEGG = 'RefusjonUtlegg',
    REISE_ANNET = 'ReiseAnnet',
    REISE_KOST = 'ReiseKost',
    REISE_KOST_MED_OVERNATTING_PAA_HOTELL = 'ReiseKostMedOvernattingPaaHotell',
    REISE_KOST_MED_OVERNATTING_PAA_HOTELL_BEORDRING_UTOVER28DOEGN = 'ReiseKostMedOvernattingPaaHotellBeordringUtover28Doegn',
    REISE_KOST_MED_OVERNATTING_PAA_HYBEL_MED_KOK_ELLER_PRIVAT = 'ReiseKostMedOvernattingPaaHybelMedKokEllerPrivat',
    REISE_KOST_MED_OVERNATTING_PAA_HYBEL_UTEN_KOK_ELLER_PENSJONAT_ELLER_BRAKKE = 'ReiseKostMedOvernattingPaaHybelUtenKokEllerPensjonatEllerBrakke',
    REISE_KOST_MED_OVERNATTING_TIL_LANGTRANSPORTSJAAFOER_FOR_KJOERING_INNENLANDS = 'ReiseKostMedOvernattingTilLangtransportsjaafoerForKjoeringInnenlands',
    REISE_KOST_MED_OVERNATTING_TIL_LANGTRANSPORTSJAAFOER_FOR_KJOERING_IUTLANDET = 'ReiseKostMedOvernattingTilLangtransportsjaafoerForKjoeringIUtlandet',
    REISE_KOST_OVERNATTING_PAA_HOTELL_BEORDRING_UTOVER28DOEGN = 'ReiseKostOvernattingPaaHotellBeordringUtover28Doegn',
    REISE_KOST_UTEN_OVERNATTING = 'ReiseKostUtenOvernatting',
    REISE_LOSJI = 'ReiseLosji',
    REISE_NATTILLEGG = 'ReiseNattillegg',
    RENTEFORDEL_LAAN = 'RentefordelLaan',
    SAERSKILT_FRADRAG_FOR_SJOEFOLK = 'SaerskiltFradragForSjoefolk',
    SJOEFOLK_ANTALL_DAGER_OM_BORD = 'SjoefolkAntallDagerOmBord',
    SKATTEFRI_ERSTATNING = 'SkattefriErstatning',
    SKATTEFRIE_UTBETALINGER = 'SkattefrieUtbetalinger',
    SKATTEPLIKTIG_DEL_FORSIKRINGER = 'SkattepliktigDelForsikringer',
    SKATTEPLIKTIG_PERSONALRABATT = 'SkattepliktigPersonalrabatt',
    SLUTTVEDERLAG = 'Sluttvederlag',
    SMUSSTILLEGG = 'Smusstillegg',
    STIPEND = 'Stipend',
    STYREHONORAR_OG_GODTGJOERELSE_VERV = 'StyrehonorarOgGodtgjoerelseVerv',
    SVALBARDINNTEKT = 'Svalbardinntekt',
    TILSKUDD_BARNEHAGEPLASS = 'TilskuddBarnehageplass',
    TILSKUDD_OG_PREMIE_TIL_PENSJON = 'TilskuddOgPremieTilPensjon',
    TIMELOENN = 'Timeloenn',
    TIPS = 'Tips',
    TREKK = 'Trekk',
    TREKK_ILOENN_FOR_FERIE = 'TrekkILoennForFerie',
    TREKK_TIL_FORDRINGSHAVER = 'TrekkTilFordringshaver',
    UREGELMESSIGE_TILLEGG_KNYTTET_TIL_ARBEIDET_TID = 'UregelmessigeTilleggKnyttetTilArbeidetTid',
    UREGELMESSIGE_TILLEGG_KNYTTET_TIL_IKKE_ARBEIDET_TID = 'UregelmessigeTilleggKnyttetTilIkkeArbeidetTid',
    UTLEGGSTREKK_SKATT = 'UtleggstrekkSkatt',
    VEDERLAG = 'Vederlag',
    VEDERLAG_TIL_DAGMAMMA_IEGET_HJEM = 'VederlagTilDagmammaIEgetHjem',
