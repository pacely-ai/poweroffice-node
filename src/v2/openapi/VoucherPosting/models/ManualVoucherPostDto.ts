...
/* tslint:disable */
/* eslint-disable */
import type { ManualVoucherLinePostDto } from './ManualVoucherLinePostDto';
/**
 * Dto for posting manual voucher type
 */
export type ManualVoucherPostDto = {
    /**
     ...
     */
    VoucherLines?: Array<ManualVoucherLinePostDto> | null;
};
