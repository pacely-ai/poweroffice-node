...
/* tslint:disable */
/* eslint-disable */
import type { BankVoucherLinePostDto } from './BankVoucherLinePostDto';
/**
 * Dto for posting bank voucher type
 */
export type BankVoucherPostDto = {
    /**
     ...
     */
    VoucherLines?: Array<BankVoucherLinePostDto> | null;
};
