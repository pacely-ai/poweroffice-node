...
/* tslint:disable */
/* eslint-disable */
import type { YearEndVoucherLinePostDto } from './YearEndVoucherLinePostDto';
/**
 * Represents a year end voucher post DTO.
 */
export type YearEndVoucherPostDto = {
    /**
     ...
     */
    VoucherLines: Array<YearEndVoucherLinePostDto> | null;
};
