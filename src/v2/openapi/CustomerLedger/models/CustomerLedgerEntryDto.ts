...
export type CustomerLedgerEntryDto = {
    ...
    /**
     * The customer account number this sub-ledger entry is posted on.
    ...
    /**
     * The external number of the customer of this sub-ledger entry.
    ...
    /**
     * The id of the customer of this sub-ledger entry.
     * Customers can be queried and identified using the Customer service.
     */
    readonly CustomerId?: number | null;
    /**
     * The name of the customer of this sub-ledger entry.
     * Customers can be queried and identified using the Customer service.
     */
    ...
    /**
     * The bank account code the OCR payment was paid from.
     * Only present on entries of vouchertype incomingOcrGiro.
     */
    readonly PaidFromBankAccount?: string | null;
    /**
     * The posting date.
