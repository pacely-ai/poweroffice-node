...
/**
 * The Employee payroll settings patch DTO contains properties relevant to altering payroll settings on an employee in Go.
 */
export type EmployeePayrollSettingsPatchDto = {
    /**
