...
/**
 * The Employee patch DTO contains properties relevant to altering an employee object in Go.
 */
export type EmployeePatchDto = {
    /**
     * The Contact group ids for this employee.
     */
