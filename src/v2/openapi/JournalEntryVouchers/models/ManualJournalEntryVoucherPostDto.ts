...
/* tslint:disable */
/* eslint-disable */
import type { ManualJournalEntryVoucherLinePostDto } from './ManualJournalEntryVoucherLinePostDto';
/**
 * Base dto for posting manual voucher types
 */
export type ManualJournalEntryVoucherPostDto = {
    /**
     ...
     */
    ManualVoucherLines?: Array<ManualJournalEntryVoucherLinePostDto> | null;
    /**
