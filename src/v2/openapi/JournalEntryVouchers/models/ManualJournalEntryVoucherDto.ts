...
/* tslint:disable */
/* eslint-disable */
import type { ManualJournalEntryVoucherLineDto } from './ManualJournalEntryVoucherLineDto';
import type { VoucherPage } from './VoucherPage';
/**
 * Dto representing properties available on manual type voucher lines.
 */
export type ManualJournalEntryVoucherDto = {
    /**
     ...
     */
    ManualVoucherLines?: Array<ManualJournalEntryVoucherLineDto> | null;
    /**
