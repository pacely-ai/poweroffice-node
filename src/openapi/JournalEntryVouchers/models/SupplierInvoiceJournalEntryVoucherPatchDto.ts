...
/**
 * Properties available for updating a journal entry supplier invoice.
 */
export type SupplierInvoiceJournalEntryVoucherPatchDto = {
    /**
    ...
    Dim3Id?: number | null;
    /**
     * The due date of the supplier invoice (i.e. when it is due paid).
