...
/**
 * The Employment Salary patch DTO contains properties relevant to altering a salary (line) on an employment relationship object in Go.
 */
export type EmploymentSalaryPatchDto = {
    /**
