...
/**
 * The Employment Fixed Salary patch DTO contains properties relevant to altering a fixed salary (line) on an employment relationship object in Go.
 */
export type EmploymentFixedSalaryPatchDto = {
    /**
