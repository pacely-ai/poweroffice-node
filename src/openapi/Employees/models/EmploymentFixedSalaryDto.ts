...
/**
 * The Employment Fixed Salary DTO contains properties relevant to a fixed salary (line) on an employment relationship object in Go.
 */
export type EmploymentFixedSalaryDto = {
    /**
    ...
    /**
     * The timestamp when the employment fixed salary entity was created.
     */
    ...
    /**
     * The id of the employment (employment relationship) the fixed salary line belongs to.
     */
    ...
    /**
     * The id of the employment fixed salary (line).
     */
    readonly Id?: string;
    /**
     * The income year.
    ...
    /**
     * The timestamp when the employment fixed salary entity was last changed.
     */
