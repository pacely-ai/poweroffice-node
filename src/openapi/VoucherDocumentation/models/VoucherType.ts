...
export enum VoucherType {
    ...
    OUTGOING_INVOICE = 'OutgoingInvoice',
    OUTGOING_CREDIT_NOTE = 'OutgoingCreditNote',
    INCOMING_BANK_REMITTANCE = 'IncomingBankRemittance',
    INCOMING_OCR_GIRO = 'IncomingOcrGiro',
    MANUAL_JOURNAL = 'ManualJournal',
    EXPENSE = 'Expense',
    CASH_JOURNAL = 'CashJournal',
    INCOMING_PAYMENTS = 'IncomingPayments',
    OUTGOING_PAYMENTS = 'OutgoingPayments',
    YEAR_END_JOURNAL = 'YearEndJournal',
    BANK_JOURNAL = 'BankJournal',
    VAT_RETURNS = 'VatReturns',
    PAYROLL_JOURNAL = 'PayrollJournal',
    OUTGOING_PAYMENT_REMINDER = 'OutgoingPaymentReminder',
    OUTGOING_NOTICE_OF_DEBT_COLLECTION = 'OutgoingNoticeOfDebtCollection',
    OUTGOING_PAYMENT_DEMAND = 'OutgoingPaymentDemand',
    OUTGOING_WARRANT_OF_EXECUTION = 'OutgoingWarrantOfExecution',
    CORRECTION_VOUCHER = 'CorrectionVoucher',
    REVERSAL_VOUCHER = 'ReversalVoucher',
    DEPRECIATION_JOURNAL = 'DepreciationJournal',
    TRAVEL_EXPENSE = 'TravelExpense',
    SETTLEMENT = 'Settlement',
    NEGATIVE_SETTLEMENT = 'NegativeSettlement',
    SYSTEM_GENERATED_DOCUMENTATION_VOUCHER = 'SystemGeneratedDocumentationVoucher',
}
